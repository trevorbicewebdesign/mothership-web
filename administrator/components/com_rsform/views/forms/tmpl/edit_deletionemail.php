...
<div class="<?php echo RSFormProAdapterGrid::row(); ?>">
	<div class="<?php echo RSFormProAdapterGrid::column(10); ?>">
		<fieldset class="form-horizontal">
			<legend class="rsfp-legend"><?php echo Text::_('COM_RSFORM_DELETION_EMAIL'); ?></legend>
			<div class="alert alert-info"><?php echo Text::_('COM_RSFORM_DELETION_EMAIL_DESC'); ?></div>
