...
<div class="container-fluid">
	<div class="<?php echo RSFormProAdapterGrid::row(); ?> text-center">
		<div class="rsfp-column-option <?php echo RSFormProAdapterGrid::column(3); ?>">
			...
			<div class="<?php echo RSFormProAdapterGrid::row(); ?>">
				<div class="<?php echo RSFormProAdapterGrid::column(12); ?>">
					<p><button class="btn btn-secondary" onclick="RSFormPro.gridModal.save([12]);" type="button"><?php echo Text::_('RSFP_GRID_ONE_COLUMN'); ?></button></p>
				</div>
			</div>
		</div>
		...
		<div class="rsfp-column-option <?php echo RSFormProAdapterGrid::column(3); ?>">
			...
			<div class="<?php echo RSFormProAdapterGrid::row(); ?>">
				<div class="<?php echo RSFormProAdapterGrid::column(12); ?>">
					<p><button class="btn btn-secondary" onclick="RSFormPro.gridModal.save([6,6]);" type="button"><?php echo Text::_('RSFP_GRID_TWO_COLUMNS'); ?></button></p>
				</div>
			</div>
		</div>
		...
		<div class="rsfp-column-option <?php echo RSFormProAdapterGrid::column(3); ?>">
			...
			<div class="<?php echo RSFormProAdapterGrid::row(); ?>">
				<div class="<?php echo RSFormProAdapterGrid::column(12); ?>">
					<p><button class="btn btn-secondary" onclick="RSFormPro.gridModal.save([4,4,4]);" type="button"><?php echo Text::_('RSFP_GRID_THREE_COLUMNS'); ?></button></p>
				</div>
			</div>
		</div>
		...
		<div class="rsfp-column-option <?php echo RSFormProAdapterGrid::column(3); ?>">
			...
			<div class="<?php echo RSFormProAdapterGrid::row(); ?>">
				<div class="<?php echo RSFormProAdapterGrid::column(12); ?>">
					<p><button class="btn btn-secondary" onclick="RSFormPro.gridModal.save([3,3,3,3]);" type="button"><?php echo Text::_('RSFP_GRID_FOUR_COLUMNS'); ?></button></p>
				</div>
			</div>
		</div>
	</div>
