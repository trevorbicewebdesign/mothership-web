...
<form method="post" action="index.php" name="adminForm" id="adminForm" class="form-validate form-horizontal">
	<fieldset>
		<legend class="rsfp-legend"><?php echo Text::_('RSFP_NEW_FORM_STEP_2_1'); ?></legend>
		<?php
	...
	<fieldset>
		<legend class="rsfp-legend"><?php echo Text::_('RSFP_NEW_FORM_STEP_2_2'); ?></legend>
		<?php
	...
	<fieldset>
		<legend class="rsfp-legend"><?php echo Text::_('RSFP_NEW_FORM_STEP_2_3'); ?></legend>
		<?php
	...
	<fieldset>
		<legend class="rsfp-legend"><?php echo Text::_('RSFP_NEW_FORM_STEP_3'); ?></legend>
